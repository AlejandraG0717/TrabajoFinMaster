...
// -------------------- WiFi --------------------
const char* ssid = "Alejandra";
const char* password = "Alejandra07";

// -------------------- MQTT --------------------
const char* mqtt_server = "ff76cb3b60b24f868536ef946a66357e.s1.eu.hivemq.cloud";
const int mqtt_port = 8883;
const char* mqtt_user = "Monisol1";
